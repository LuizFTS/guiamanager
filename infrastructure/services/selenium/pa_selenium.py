...
class GuiaGeneratorPASelenium(IGuiaGeneratorService):
    ...
    def _icms(self, guia: Guia):
        ...
        s.digitar('//*[@id="content"]/div/div/div/form/async-loader/div/md-card/md-card-content/div[1]/div[2]/md-input-container[2]/md-datepicker/div[1]/input', guia.vencimento)
